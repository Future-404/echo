...
const Luminescence: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      <label className="text-[9px] tracking-widest text-gray-400 dark:text-gray-600 uppercase italic px-4 underline decoration-gray-100 dark:decoration-gray-800 underline-offset-8">Luminescence</label>
