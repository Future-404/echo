...
const DialogueBox: React.FC<DialogueBoxProps> = ({ displayText, isTyping, onCanAdvanceChange, onRetry, onSkipGreeting }) => {
  ...
  return (
    ...
    >
      {/* 顶部状态条 & 任务集成栏 - 增加 sticky 确保移动端滚动时不消失 */}
      <div className="sticky top-0 z-40 flex flex-col border-b border-gray-300/10 dark:border-white/5 bg-echo-base/90 dark:bg-black/80 backdrop-blur-xl" onClick={e => e.stopPropagation()}>
